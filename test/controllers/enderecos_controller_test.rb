...
class EnderecosControllerTest < ActionController::TestCase
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post :create, endereco: { cidade: @endereco.cidade, contato_id: @endereco.contato_id, estado: @endereco.estado, rua: @endereco.rua }
    end
  ...
  test "should update endereco" do
    patch :update, id: @endereco, endereco: { cidade: @endereco.cidade, contato_id: @endereco.contato_id, estado: @endereco.estado, rua: @endereco.rua }
    assert_redirected_to endereco_path(assigns(:endereco))
  end
