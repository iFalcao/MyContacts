...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, contato: { email: @contato.email, nome: @contato.nome, observacao: @contato.observacao, tipo_id: @contato.tipo_id }
    end
  ...
  test "should update contato" do
    patch :update, id: @contato, contato: { email: @contato.email, nome: @contato.nome, observacao: @contato.observacao, tipo_id: @contato.tipo_id }
    assert_redirected_to contato_path(assigns(:contato))
  end
